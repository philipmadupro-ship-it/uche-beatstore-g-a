      ...
      await resend.emails.send({
        ...
        html: emailShell('U2C Beatstore',
          `${emailHeading('Your stems are ready')}
           <p style="color:#D0C3AF;font-size:13px;margin:0 0 20px">The producer has uploaded the stems for your exclusive purchase. Download them any time from your delivery page.</p>
