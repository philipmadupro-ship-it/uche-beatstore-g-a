    ...
    return (
      <div className="min-h-screen bg-[#0a0907] text-[#E8DCC8] flex items-center justify-center px-4">
        <div className="max-w-sm text-center">
          ...
          <p className="text-[11px] text-[#a08a6a] mb-5">{msg}</p>
          <Link
            href="/store/account"
    ...
    <div className="min-h-screen bg-[#0a0907] text-[#E8DCC8]">
      <div className="max-w-[760px] mx-auto px-4 py-10 md:py-14">
        <div className="flex items-center justify-between mb-8">
          <Link
            href="/store"
            className="inline-flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-[0.2em] text-[#6a5d4a] hover:text-[#E8DCC8] transition-colors"
          >
            <ArrowLeft size={12} />
            Back to store
          </Link>
              ...
              <section className="mt-10">
                ...
                <ul className="space-y-2">
                  {data.project_bundles.map((b) => (
                    <li key={b.id} className="flex items-center gap-3 rounded-xl border border-[#1f1a13] bg-[#14110d] px-3 py-3">
              ...
              <section className="mt-10">
                ...
                <ul className="space-y-2">
                  {data.track_licenses.map((r) => (
                    <li key={r.id} className="rounded-xl border border-[#1f1a13] bg-[#14110d] px-4 py-3">
            ...
            <section className="mt-10 rounded-2xl border border-[#1f1a13] bg-[#14110d] px-5 py-5">
              <div className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-md text-[10px] font-mono uppercase tracking-wider border border-[#2d2620] text-[#E8DCC8] hover:border-[#3a3328] hover:bg-white/[0.04] transition-colors"
                >
        ...
        <footer className="mt-10 pt-6 border-t border-[#1a160f]">
          <p className="text-[10px] font-mono text-[#3a3328] leading-relaxed">
            ...
            <button onClick={handleSignOut} className="text-[#6a5d4a] hover:text-[#E8DCC8] underline underline-offset-2">
              Sign out
            </button>{' '}
            any time.
          </p>
        ...
        {data.playlists.length === 0 ? (
          ...
          <ul className="space-y-1.5">
            {data.playlists.map((p) => (
              <li key={p.id} className="flex items-center gap-3 px-3 py-2 rounded-lg bg-white/[0.03] border border-[#1f1a13]">
