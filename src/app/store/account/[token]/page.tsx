            ...
            <section className="mt-10 rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-5">
              <div className="flex items-start gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-md text-[10px] font-mono uppercase tracking-wider border border-white/20 text-white hover:border-white/40 hover:bg-white/[0.04] transition-colors disabled:opacity-40"
                >
                  {portalLoading
