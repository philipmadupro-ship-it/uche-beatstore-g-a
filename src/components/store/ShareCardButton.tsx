  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 id="share-card-title" className="text-[14px] font-semibold text-white mb-4 pr-8 break-words">
          {trackTitle}
        </h3>
...
export function ShareCardButton({
  trackId, trackTitle, kind = 'playing', variant = 'pill', accentColor = '#FFFFFF',
}: ButtonProps) {
      ...
      <button
        ...
        className={
          variant === 'icon'
            ...
            : 'flex items-center gap-1.5 px-3 py-2 rounded-full bg-white/[0.06] border border-white/[0.10] text-white text-[11px] font-mono uppercase tracking-[0.18em] hover:bg-white/[0.10] transition-colors'
        }
      >
