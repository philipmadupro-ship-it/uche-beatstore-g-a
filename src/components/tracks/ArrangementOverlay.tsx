...
const SEGMENT_TONES: Record<string, { bg: string; ring: string; text: string }> = {
  ...
  hook:    { bg: 'bg-[#3a4a2a]/40', ring: 'ring-white/30',  text: 'text-[#c8e090]' },
  outro:   { bg: 'bg-[#1f5a4a]/40', ring: 'ring-white/30',  text: 'text-[#94d9bc]' },
  default: { bg: 'bg-white/[0.03]', ring: 'ring-white/[0.08]',  text: 'text-white/80' },
};
  ...
  return (
    <div className="mb-3">
      <div className="flex items-center justify-between mb-1.5">
        <p className="text-[9px] font-mono uppercase tracking-[0.2em] text-white/40 flex items-center gap-1.5">
          <MapIcon size={10} />
          Arrangement
        </p>
