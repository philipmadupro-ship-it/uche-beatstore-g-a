        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-7 custom-scrollbar">
          ...
          <div className="relative aspect-square w-full rounded-2xl overflow-hidden bg-white/[0.04] border border-white/10 group shadow-[0_24px_60px_-12px_rgba(0,0,0,0.7)]">
            ...
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="w-16 h-16 rounded-full text-white flex items-center justify-center hover:bg-white/[0.08] hover:scale-105 transition-all"
              >
                {isCurrentPlaying ? (
                  <Pause size={30} />
                ) : (
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-4 space-y-3">
            <div className="flex items-center gap-3">
              <button
                onClick={handlePlayToggle}
                className="w-10 h-10 rounded-full text-white flex items-center justify-center hover:bg-white/[0.08] hover:scale-105 transition-all shrink-0"
              >
                {isCurrentPlaying ? (
                  <Pause size={20} />
                ) : (
